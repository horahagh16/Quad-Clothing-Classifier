...
SEARCHING = 'searching'
GOING_TO_LAND_SITE = 'going to land site'
LANDING = 'landing'
LANDED = 'landed'
...
class Mavic(Robot):
    ...
    def __init__(self):
        ...
        self.front_left_led.set(False)
        self.front_right_led.set(False)
        ...
        self.camera_pitch_motor.setPosition(np.pi / 2)  # Look down
    ...
    def take_picture(self):
        ...
        for y in range(height):
            ...
            for x in range(width):
                r = Camera.imageGetRed(img_raw, width, x, y)
                g = Camera.imageGetGreen(img_raw, width, x, y)
                b = Camera.imageGetBlue(img_raw, width, x, y)
                row.append([r, g, b])
            img.append(row)
    ...
    def check_target_image(self):
        ...
        cv2.imshow('image taken', img_bgr)
